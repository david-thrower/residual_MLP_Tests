...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        type=str,
        help =\
            "Flatten output of base model before forwarding to the "\
    ...
    parser.add_argument(
        ...
        type=int,
        help =\
            "Which residual Multi Layer Perceptron architecture "
            + "selection to try?",
        default=2
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--dropout_rate",
        type=float,
        help = "Dropout rate. Ignored unless b_norm_or_dropout_last_layers set to 'dropout'.",
        default = 'bnorm'
    )
    parser.add_argument(
        "--results_dir",
